...
Public Class Form2
    ...
    Private Sub Savebtn_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs)
    ...
    Friend Sub clear()
        ...
        CustomerMobile.ResetText()
        CustomerStatus.ResetText()
        CustOwner.ResetText()
        CustOwnerMob.ResetText()
        CustContactNo.ResetText()
